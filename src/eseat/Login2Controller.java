...
public class Login2Controller implements Initializable {
    ...
    void back(ActionEvent event) throws IOException {
        ...
        window.show();
         ...
         @FXML
    void finaloutput2(ActionEvent event) throws IOException {
        
        
        
         Parent login = FXMLLoader.load(getClass().getResource("finaloutput2.fxml"));
    ...
    public void reserveSeat(ActionEvent event) throws IOException{
        ...
        {
            output2.setText("A1");
            FileWriter fw = new FileWriter("longdata.txt", true);
                    BufferedWriter writer = new BufferedWriter(fw);
                     writer.append("A1");
                     writer.newLine();
                    writer.close();
